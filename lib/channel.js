...
class ChromeRuntimeChannel {
    constructor(runtime) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            ...
            hookObject(this.constructor.name, methods, this, process.env.TRACE || process.env.TRACE_CHROME_RUNTIME_CHANNEL)
        }
    }
...
class GenericChannel {
    ...
    constructor(runtime) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            ...
            hookObject(this.constructor.name, methods, this, self.TRACE || self.GENERIC_CHANNEL_TRACE)
        }
    }
...
class ChannelProxy {
    constructor(firstRuntime, secondRuntime) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            ...
            hookObject(this.constructor.name, methods, this, self.TRACE || self.CHANNEL_PROXY_TRACE)
        }
    }
